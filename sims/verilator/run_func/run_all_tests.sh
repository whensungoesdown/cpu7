...
echo -e "\n\n\nTest func_uty59_csr.era\n"
movetotrash ./obj/func/
./configure.sh -run func/func_uty59_csr.era --disable-trace-comp
make soft_compile
make simulation_run_func


echo -e "\n\n\nTest func_uty60_exception.ale_csr_pc2era\n"
movetotrash ./obj/func/
./configure.sh -run func/func_uty60_exception.ale_csr_pc2era --disable-trace-comp
make soft_compile
make simulation_run_func


echo -e "\n\n\nTest func_uty61_ertn\n"
movetotrash ./obj/func/
...
echo -e "\n\n\nTest func_uty63_ertn_prmd2crmd\n"
movetotrash ./obj/func/
...
echo -e "\n\n\nTest func_uty65_csr.bsec\n"
movetotrash ./obj/func/
./configure.sh -run func/func_uty65_csr.bsec --disable-trace-comp
make soft_compile
make simulation_run_func
