...
do
    case $software in 
        ...
        func/func_uty42_bge) 
            ...
            mkdir -p ./log/func
            ;;
        func/func_uty43_bltu) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty44_bgeu) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        ...
        func/func_uty46_bl) 
            ...
            mkdir -p ./log/func
            ;;
        func/func_uty47_funccall) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty48_ld.b) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty49_ld.h) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty50_ld.bu) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty51_ld.hu) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty52_st.b) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty53_st.h) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty54_addrmisalignexception) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty55_csr.eentry) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty56_ld_ale) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty57_csr.prmd) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty58_exception_crmd2prmd) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty59_csr.era) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty60_exception.ale_csr_pc2era) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty61_ertn) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty62_branch_next_instruction_executed_mistake) 
            ...
            mkdir -p ./log/func
            ;;
        func/func_uty63_ertn_prmd2crmd) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty64_exception.illinst) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
        func/func_uty65_csr.bsec) 
            RUN_FUNC=y
            mkdir -p ./obj/func
            mkdir -p ./log/func
            ;;
