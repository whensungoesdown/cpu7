...
#define CONFREG_NUM_REG         top->rootp->simu_top__DOT__soc__DOT__confreg__DOT__num_data
#define CONFREG_OPEN_TRACE      top->rootp->simu_top__DOT__soc__DOT__confreg__DOT__open_trace
#define CONFREG_NUM_MONITOR     top->rootp->simu_top__DOT__soc__DOT__confreg__DOT__num_monitor
//#define CONFREG_UART_DISPLAY    top->rootp->simu_top__DOT__soc__DOT__confreg__DOT__confreg_uart_valid
#define CONFREG_UART_DATA       top->rootp->simu_top__DOT__soc__DOT__confreg__DOT__confreg_uart_data  
#define CONFREG_UART_DISPLAY    top->rootp->simu_top__DOT__soc__DOT__confreg__DOT__write_uart_valid  
#ifdef RUN_FUNC
...
class GoldenTrace:CpuTool
{
    ...
    int process(vluint64_t main_time){
	    ...
	    // uty: test
            ...
            if (top->debug0_wb_pc==END_PC) sim_over = 1;
